...
export const portfolioListData: PortfolioListData[] = [
  {
    ...
    description: "Built a responsive anime search application using the JikanAPI to practice API integration and state management. Features include real-time search, detailed anime information pages with ratings, and a clean, mobile-first interface that provides seamless browsing experience.",
    ...
    imgUrl: "/images/projects/anime-search-app.jpg",
  ...
  },
  {
    ...
    description: "Initial portfolio website built to showcase projects and establish online presence. Features fullpage.js-inspired fullscreen section scrolling, clean design, and fast loading times. Focused on accessibility and smooth user experience with section-based navigation.",
    ...
    imgUrl: "/images/projects/github-pages-v1.jpg",
  ...
  },
  {
    ...
    description: "Portfolio website combining professional web development with anime-inspired design. Built with Next.js for optimized performance, server-side rendering, and modern React patterns. Features dynamic routing, image optimization, and a unique visual identity.",
    ...
    imgUrl: "/images/projects/otaku-portfolio.jpg",
